 ...
 <head>
     ...
     <!-- Fonts and icons -->
     <script src="{{asset('adminpage/assets/js/plugin/webfont/webfont.min.js')}}"></script>
     <script>
         WebFont.load({
     ...
     <!-- CSS Files -->
     <link rel="stylesheet" href="{{asset('adminpage/assets/css/bootstrap.min.css')}}">
     <link rel="stylesheet" href="{{asset('adminpage/assets/css/atlantis.min.css')}}">
     <!-- CSS Just for demo purpose, don't include it in your project -->
     <link rel="stylesheet" href="{{asset('adminpage/assets/css/demo.css')}}">
 </head>
 <body>
         ...
         <div class="main-header">
             ...
             <div class="logo-header" data-background-color="blue">
                 ...
                 <a href="../index.html" class="logo">
                     <img src="{{asset('adminpage/assets/img/logo.svg')}}" alt="navbar brand" class="navbar-brand">
                 </a>
     ...
     <!--   Core JS Files   -->
     <script src="{{asset('adminpage/assets/js/core/jquery.3.2.1.min.js')}}"></script>
     ...
     <!-- jQuery UI -->
     <script src="{{asset('adminpage/assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js')}}"></script>
     <script src="{{asset('adminpage/assets/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js')}}"></script>
     
     <!-- jQuery Scrollbar -->
     <script src="{{asset('adminpage/assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js')}}"></script>
     <!-- Atlantis JS -->
     <script src="{{asset('adminpage/assets/js/atlantis.min.js')}}"></script>
     <!-- Atlantis DEMO methods, don't include it in your project! -->
 <script src="{{asset('adminpage/assets/js/setting-demo2.js')}}"></script>
 </body>
 </html>
